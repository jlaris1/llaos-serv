                        ...
                        if(error){
                            ...
                            Proveedores.findById({"_id": orden.proveedor}, function(error, proveedor){
                                ...
                                // Datos de la moneda
                                    ...
                                    .text(fmon.FormatMoney(true, orden.subtotal), 520, 670, { align: 'right', width: 80 })
                                    .text("IVA", 440, 685, { align: 'right', width: 80 })
                                    .text(fmon.FormatMoney(true, orden.iva), 520, 685, { align: 'right', width: 80 })
                                    .text("Total", 440, 700, { align: 'right', width: 80 })
                                    .text(fmon.FormatMoney(true, orden.total), 520, 700, { align: 'right', width: 80 })
